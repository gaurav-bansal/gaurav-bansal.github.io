// muRata Light sensor Starter Kit for RaspberryPi
...
int main(int arc, char **argv) 
{
	int f_led=0;
	double g_cnt;
	char *logfile = "/home/pi/gaurav-bansal.github.io/lightlog.txt";
	FILE *fp;
	int i=1;
	...
	//while(1){
		...
		fp = fopen(logfile, "a"); 
		fprintf(fp, "%4d/%2d/%2d %2d:%2d:%2d\t Lux : %.2lf\n", year, mon, day, hour, min, sec, g_cnt);
		fclose(fp);

		printf("%4d/%2d/%2d %2d:%2d:%2d\t Lux : %.2lf\n", year, mon, day, hour, min, sec, g_cnt);
